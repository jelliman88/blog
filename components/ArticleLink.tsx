...
const ArticleLink = ({ article }: any) => {
    ...
    return (
        <Link href={`/article/${article.slug}`} className='p-6 w-52 mx-auto my-2 border border-black border-4 rounded-lg shadow sm:flex sm:flex-wrap sm:justify-center hover:bg-black hover:text-white dark:border-white dark:hover:bg-white dark:hover:text-black
        transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300'>
            ...
            <Image className="rounded m-auto" src={url} alt="logo" height="100" width="100" />
            </div>
